...
import br.com.gabrielmaran.pessoa.integrationtest.dto.wrapper.json.book.WrapperBookDTO;
...
class BookControllerJSONTest extends AbstractIntegrationTest {
    ...
    void findAll() throws JsonProcessingException {
        ...
        List<BookDTO> booksSearched = wrapper.getEmbedded().getBooks();
        ...
        assertEquals(BigDecimal.valueOf(88), BigDecimal.valueOf(book.getPrice().intValueExact()));
    }
