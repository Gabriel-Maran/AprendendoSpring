...
import br.com.gabrielmaran.pessoa.exception.UnsupportedMethodOperationException;
...
public class CustomEntityResponseHandler extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<ExceptionResponse> handleUnsupportedMethodOperation
            (UnsupportedMethodOperationException ex, WebRequest request)
    {
